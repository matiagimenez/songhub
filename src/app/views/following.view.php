...
<body>
    ...
    <main>
        ...
        <section class="users">
            ...
            <article class="user">
                <img loading="lazy" height="70px" width="70px"
                    src="https://i.pinimg.com/564x/92/94/73/92947360e1b0f2b1a8bd1352c26dd97c.jpg"
            ...
            <article class="user">
                ...
                <a href="#" class="action-button submit-outline-button">Siguiendo</a>
            </article>
            <article class="user">
                <img loading="lazy" height="70px" width="70px"
